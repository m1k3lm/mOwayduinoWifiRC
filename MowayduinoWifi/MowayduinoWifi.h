...
unsigned char local_ip[] = {192,168,1,253};	// IP address of mOwayduino
...
const char EXT_SERVER[] = "http://m1k3lm.github.io/mOwayduinoWifiRC/";
const char LOCAL_IP[] = "192.168.1.253";
